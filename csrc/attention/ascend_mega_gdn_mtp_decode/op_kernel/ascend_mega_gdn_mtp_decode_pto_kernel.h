...
namespace ascend_mega_gdn_mtp_decode_pto {
...
// existing AIV-only software barrier. ascend_mega_gdn_mtp_decode does not call it.
...
AICORE PTO_INLINE void Run(
  ...
  // dynamically addressed all-token Q/K tiles.
  TileUbDataND<
      float,
