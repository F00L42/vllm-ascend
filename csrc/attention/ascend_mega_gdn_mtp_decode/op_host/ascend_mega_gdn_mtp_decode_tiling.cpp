...
#include "ascend_mega_gdn_mtp_decode_tiling.h"
...
static ge::graphStatus AscendMegaGdnMtpDecodeTiling(
  ...
  AscendMegaGdnMtpDecodeTilingData tiling;
...
IMPL_OP_OPTILING(AscendMegaGdnMtpDecode).Tiling(AscendMegaGdnMtpDecodeTiling);
